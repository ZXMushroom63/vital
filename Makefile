...
EMXXFLAGS := -msimd128 -mavx2 -sINVOKE_RUN=0 -sSTACK_SIZE=104857600 -sALLOW_MEMORY_GROWTH=0 --cache ./emsdk_cache -sUSE_WEBGL2=1 -sFULL_ES2=1 -sFULL_ES3=1 -sMIN_WEBGL_VERSION=2 -sMODULARIZE=1 -sEXPORT_NAME='createVial' -sEXPORTED_FUNCTIONS="['_setupAudioThread','_main']" -sEXPORTED_RUNTIME_METHODS="['HEAPU8','HEAPF32','HEAPU32','HEAP32','HEAPF64','FS']" -sLEGACY_VM_SUPPORT=0 -sINITIAL_MEMORY=681574400 -sIMPORTED_MEMORY=1 -sSHARED_MEMORY=1 -sUSE_PTHREADS=1 -sPTHREAD_POOL_SIZE=2 -sFORCE_FILESYSTEM -lidbfs.js
