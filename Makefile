...
EMXXFLAGS := -msimd128 -mavx2 -sINVOKE_RUN=0 -sSTACK_SIZE=104857600 -sALLOW_MEMORY_GROWTH=0 --cache ./emsdk_cache -sUSE_WEBGL2=1 -sFULL_ES2=1 -sFULL_ES3=1 -sMIN_WEBGL_VERSION=2 -sMODULARIZE=1 -sEXPORT_NAME='createModule' -sEXPORTED_FUNCTIONS="['_setupAudioThread','_main']" -sEXPORTED_RUNTIME_METHODS="['HEAPU8','HEAPF32','HEAPU32','HEAP32','HEAPF64']" -sLEGACY_VM_SUPPORT=0 -sINITIAL_MEMORY=643366912 -sIMPORTED_MEMORY=1 -sSHARED_MEMORY=1 -sUSE_PTHREADS=1 -sPTHREAD_POOL_SIZE=2 -sMALLOC=mimalloc
...
#RELEASE CONFIGS
EMMXFLAGS += -O3 -flto -fvisibility=hidden "-DNDEBUG=1" --closure 1 -sEVAL_CTORS -fno-rtti -fno-exceptions -g0 -sSIMD=1 -sNO_EXIT_RUNTIME=1 -ftree-vectorize -finline-functions -funroll-loops -fvectorize -ffast-math --use-llvm-opts --disable-assertions
#EMMXFLAGS += -g3 -ggdb
