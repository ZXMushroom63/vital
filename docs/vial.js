...
function initMemory() {
  ...
  {
    var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 642252800;
...
var ASM_CONSTS = {
  135629404: () => { globalThis.vIDBFS = IDBFS; globalThis.vMEMFS = MEMFS; }
};
...
var _vialInvalidateGui = Module['_vialInvalidateGui'] = makeInvalidEarlyAccess('_vialInvalidateGui');
var _vialRedraw = Module['_vialRedraw'] = makeInvalidEarlyAccess('_vialRedraw');
...
var _testNewBounds = Module['_testNewBounds'] = makeInvalidEarlyAccess('_testNewBounds');
var _testRepaint = Module['_testRepaint'] = makeInvalidEarlyAccess('_testRepaint');
...
function assignWasmExports(wasmExports) {
  ...
  Module['_vialInvalidateGui'] = _vialInvalidateGui = createExportWrapper('vialInvalidateGui', 0);
  Module['_vialRedraw'] = _vialRedraw = createExportWrapper('vialRedraw', 0);
  ...
  Module['_testNewBounds'] = _testNewBounds = createExportWrapper('testNewBounds', 0);
  Module['_testRepaint'] = _testRepaint = createExportWrapper('testRepaint', 0);
